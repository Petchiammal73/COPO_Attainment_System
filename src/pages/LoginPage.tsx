        ...
        >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder={role === "admin" ? "admin@university.edu" : "faculty@university.edu"}
                  value={email}
          ...
          <div className="mt-6 p-4 rounded-lg bg-muted/50 border border-border">
            ...
            <div className="space-y-1 text-xs text-muted-foreground">
              <p><span className="font-medium text-foreground">Admin:</span> admin@university.edu / admin123</p>
              <p><span className="font-medium text-foreground">Faculty:</span> faculty@university.edu / faculty123</p>
            </div>
          </div>
        </motion.div>
      </div>
